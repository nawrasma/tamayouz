...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <title>@yield("title","Tamayouz Competition-Dashboard")</title>
            ...
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                <div class="d-table m-auto">
                  <img id="main-logo" class="d-inline-block align-top mr-1" style="max-width: 25px;" src={{ asset('assestMaster/images/shards-dashboards-logo.svg') }} alt="Shards Dashboard">
                  <span class="d-none d-md-inline ml-1">Tamayouz Dashboard</span>
                </div>
              </a>
              ...
              <ul class="navbar-nav border-left flex-row ">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img class="user-avatar rounded-circle mr-2" src={{ asset('assestMaster/images/avatars/0.jpg') }} alt="User Avatar">
