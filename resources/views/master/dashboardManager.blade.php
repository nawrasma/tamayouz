                      ...
                      @foreach ($projects as $porject)
                        <div class="blog-comments__item d-flex p-3">
                          <div class="blog-comments__avatar mr-3">
                            <img src="{{ asset("images/".$porject->pro_photo) }} " alt="{{$porject->pro_photo}}" /> </div>
                          <div class="blog-comments__content">
                            <div class="blog-comments__meta text-muted">
                              <a class="text-secondary" href="/home/project/{{$porject->id}}">{{$porject->pro_name}}</a> 
                              <span class="text-muted">– {{getDifferenceDate($porject->created_at,date('Y-m-d H:i:s') ) }}</span>
                            </div>
                            <p class="m-0 my-1 mb-2 text-muted">{{ substr($porject->pro_desc,0,55) }} ...</p>
                            <div class="blog-comments__actions">
                              <div class="btn-group btn-group-sm">
                                <a href="/home/project/{{$porject->id}}" class="btn btn-white">
